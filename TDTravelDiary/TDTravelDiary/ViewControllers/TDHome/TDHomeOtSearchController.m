...
@interface TDHomeOtSearchController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (nonatomic,strong) UIAlertController *alertController;
@end

@implementation TDHomeOtSearchController
...
-(NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    return self.otSourceArray.count;
}
//返回cell
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TDHomeSearchListInfo *listInfo = self.otSourceArray[indexPath.item];

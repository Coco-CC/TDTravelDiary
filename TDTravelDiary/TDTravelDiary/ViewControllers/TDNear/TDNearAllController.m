...
@interface TDNearAllController ()<CLLocationManagerDelegate>
...
@implementation TDNearAllController
...
//    if(!cell)
//    {
//        [tableView registerNib:[UINib nibWithNibName:@"TDNearViewCell" bundle:nil] forCellReuseIdentifier:@"cell"];
//        
//    
//    }
